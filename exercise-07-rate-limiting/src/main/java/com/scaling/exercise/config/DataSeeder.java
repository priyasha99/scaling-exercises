...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        // Seed default users (NEW for Exercise 05)
        seedUsers();
    }
     ...
     * user/user123   — USER role (standard access)
     * alice/alice123  — USER role (for multi-user load testing)
     * bob/bob123      — USER role (for multi-user load testing)
     */
