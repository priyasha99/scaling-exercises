...
/**
 * Spring Security configuration — STATELESS + Rate Limiting.
 *
 * FILTER ORDER (Exercise 07):
 ...
 * authenticated username for per-user rate limiting. If it ran
 * before JWT, all requests would use per-IP limiting.
 */
@Configuration
@EnableWebSecurity
